...
export class FormDialogComponent implements OnInit {
    ...
    status: any[] = [
        { values: 'pending', name: 'รอรับมัดจำ' },
        { values: 'deposit_received', name: 'รับมัดจำ' },
        { values: 'waiting_for_finance', name: 'รอผลไฟแนนซ์' },
        { values: 'finance_approved', name: 'ไฟแนนซ์อนุมัติผล' },
        { values: 'waiting_for_delivery', name: 'รอรับรถ' },
        { values: 'completed', name: 'ส่งมอบเรียบร้อย' },
        { values: 'cancelled', name: 'ยกเลิกการขาย' },
    ];
    ...
    ngOnInit(): void {
        ...
        this.addForm = this.formBuilder.group({
            order_id: [this.data ? this.data.itemId : ''],
    ...
    onSaveClick(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            if (result === 'confirmed') {
                ...
                this._service.statusUpdate(this.addForm.value).subscribe({
                    next: (resp: any) => {
