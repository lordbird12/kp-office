...
export class PageService {
    ...
    getChecklist(): Observable<any> {
        return this._httpClient
            .get<any>(environment.baseURL + '/api/get_check_lists')
            .pipe(
                tap((result) => {
                    this._data.next(result);
                })
    ...
    getPageProduct(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
    ...
    statusUpdate(data: FormData): Observable<any> {
        return this._httpClient
            .post<any>(environment.baseURL + '/api/update_status_orders', data)
            .pipe(
                tap((result) => {
                    this._data.next(result);
                })
