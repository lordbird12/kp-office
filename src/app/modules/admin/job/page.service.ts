...
export class Service {
    ...
    create(data: FormData): Observable<any> {
        return this._httpClient
            .post<any>(environment.baseURL + '/api/jobs', data)
            .pipe(
                tap((result) => {
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.baseURL + '/api/jobs/' + id,
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.baseURL + '/api/jobs_page',
    ...
    update(data: FormData, id: number): Observable<any> {
        ...
        // }
        return this._httpClient
            .put(environment.baseURL + '/api/jobs/' + id, data)
            .pipe(
                switchMap((response: any) => {
                    // Return a new observable with the response
                    return of(response);
    ...
    updateStatus(data: any, Id:number): Observable<any> {
        return this._httpClient.put<any>(
            environment.baseURL + '/api/update_status_jobs_work_type/' + Id,
            data,
            this.httpOptionsFormdata
        );
    }
